...
Because the part of your brain running the show right now is not the part that trained for this race. It's not the part that analyzed your power data or planned your pacing strategy or figured out your nutrition. It's the part that kept your ancestors alive on the African savannah 200,000 years ago. And it doesn't know the difference between a lion and a start line. To this part of your brain, the elevated heart rate, the crowd, the competition — it all registers the same way: threat.
...
That gap is real. And it's trainable. The entire point of mental skills training — this whole course, every lesson, every tool — is to widen that gap. To give the coach enough time to show up before the chimp does something stupid.
...
That's what this entire course is about. Not fighting your brain. Training it.
...
Maybe it's the moment you look at your intervals on the plan and think "I don't want to do these." Maybe it's when a car passes too close and your whole body tenses up and your grip tightens on the bars. Maybe it's when your power drops 10 watts below target and your first thought is "I'm not fit enough, I've been wasting my time." Maybe it's the moment you see another rider up the road and your legs want to chase before your brain has decided whether chasing is smart. Maybe it's when you hit a headwind and think "of course, always a headwind."

When that moment happens, I want you to name it. Internally, silently, just say to yourself: "That was the chimp."

That's it. You don't fix it. You don't fight it. You don't judge it. You don't try to change the thought. You just see it and name it.

Why? Because naming the reactive response is the first step to creating the gap. You can't widen a gap you don't know exists. Right now, for most of you, stimulus and response are welded together into one seamless experience. Something happens, you react, and it feels like a single event — like the reaction IS the experience. It's not. There are two things happening. The chimp fires. Then you respond to what the chimp did. The Gap Check teaches you to see the seam between them.

This is the seed of everything else. When you can see the chimp fire — when you can catch it in the act and say "ah, there it is" — you've already created a tiny gap. A sliver of space between the reactive impulse and your actual response. And into that sliver, we're going to insert an entire toolkit over the next five modules.

Do this for one session. That's your homework. See the chimp. Name the chimp. Don't fix the chimp. We'll learn what to do about the chimp later. For now, just prove to yourself that the gap exists.
...
Noakes looked at that model and said: hold on. If fatigue is purely peripheral — purely a muscle thing — then why do runners speed up at the end of marathons? If your muscles are at their physical limit at mile 24, where does the sprint finish at mile 26 come from? If you're truly at maximum capacity, a kick shouldn't be possible. But it happens. All the time. Elite and amateur alike. The end sprint is nearly universal in endurance racing.
...
First, at the single hardest moment of the session — the moment where you most wanted to quit, where the effort felt absolutely maximal — rate your RPE on a 1-to-10 scale. 10 is "I literally cannot continue, not one more second." Be honest. Just note the number mentally or, if you can, tap it into your phone or bike computer.

Second, ten minutes after you finish the session — after you've caught your breath, had some water, let your heart rate come back down — rate that same moment again. Same scale, same question. How hard was that hardest moment, looking back on it now?

Compare the two numbers.

For almost everyone, the retrospective rating is lower. Sometimes by one point, sometimes by two or three. A moment that felt like a 9 — absolute maximum, couldn't-possibly-continue — becomes a 7 in retrospect. Or a moment that felt like a 10 becomes an 8. You'll look at it and think, "Yeah, it was hard, but it wasn't THAT hard."

Why? Because in the moment, the chimp was adding a surcharge. Fear, frustration, catastrophic thinking, uncertainty about how much longer it would last, anxiety about the outcome — all of that gets layered on top of the actual physical sensation. The raw physical effort was a 7. The chimp's emotional markup made it feel like a 9.

That gap between in-the-moment RPE and retrospective RPE? That's your brain's tax. That's the margin the chimp charges for the privilege of being uncomfortable. And once you can see it — once you have three data points proving that your brain consistently overstates effort by 1-3 points — you can start to account for it. You can be in the middle of a hard effort, feeling a 9, and think: "The chimp says 9. It's probably a 7. I can do a 7."

Do this for three sessions. Write down both numbers each time. Notice the pattern. Your brain is the limiter — and now you have the receipts.
...
There's a dial in your brain. Think of it like a volume knob that goes from 1 to 10. At 1, you're asleep. At 10, you're in full panic mode — fight or flight, hands shaking, can't think straight. Your best performance doesn't live at either extreme. It lives in a specific zone somewhere in the middle — and that zone is different for every athlete, for every sport, and even for every situation within a sport.

This is the principle of arousal regulation. Your nervous system has a throttle, and it's always set somewhere on that 1-to-10 dial. Learning where YOUR optimal zone sits — and more importantly, learning how to move the dial there on demand — is one of the most practical, immediately useful skills in all of sport psychology.
...
The good news? You can learn to move that dial. Both directions. If you're a Jason — chronically over-aroused on race day — you need tools to activate the parasympathetic brake. We'll cover the best one in the next lesson. If you're a Sarah — under-aroused, too flat for competition — you need tools to hit the sympathetic accelerator: pre-race music, power phrases, controlled aggression cues. We'll get to those later in the course. But first, you need to know where YOUR dial sits when you perform your best.
...
Be honest. Don't rate what you think the "right" answer should be. Rate what you actually felt. Were you calm and focused? That's maybe a 4 or 5. Were you buzzing with energy but still in control? That's a 6 or 7. Were you nervous but channeling it? That's a 5 or 6.

Now think about your last three worst performances. Races where you underperformed relative to your fitness. Sessions where you couldn't access what you knew was there. Moments where you know you left something on the table. Rate those on the same 1-to-10 scale.

Look at the two sets of numbers. Where do your best performances cluster? That's your zone. For most endurance athletes, it's somewhere between 4 and 6. Not dead calm, not amped to the gills. Alert, focused, a little bit of butterflies but not overwhelmed. Enough edge to be sharp, not so much that you're brittle.

Where do your worst performances cluster? If they're consistently higher than your best performances — 7s, 8s, 9s — you're a Jason. You come to competition over-aroused and you need to learn to bring the dial down. If they're consistently lower — 2s, 3s, 4s — you're a Sarah. You come to competition under-activated and you need to learn to bring the dial up.

Write these numbers down. Seriously. In a notebook, in your phone, wherever you track training notes. Because we're about to start building tools that move the dial, and you need to know which direction you need to move it.
...
Diaphragmatic breathing — deep belly breathing, where your diaphragm pulls down and your belly expands, as opposed to the shallow chest breathing that happens automatically when you're stressed — is the fastest, most reliable way to shift your nervous system from sympathetic (fight or flight) to parasympathetic (rest and think clearly).

The formula is 6-2-7. Breathe in for 6 seconds. Hold for 2 seconds. Exhale for 7 seconds. That's 15 seconds total per cycle. And every one of those numbers matters — I'll explain why.

### THE SCIENCE

This isn't woo-woo breathing exercises from a yoga retreat. This is neuroscience.
...
Hold for a count of 2. Don't tense up during the hold. Just... pause. The air is in your lungs. Let it sit there for two beats.

Then exhale through your mouth for a slow count of 7. Pursed lips, like you're blowing through a straw. Let the air flow out steadily and completely. Don't force it — just let it drain out. By count 7, your lungs should feel empty.
...
The 6-2-7 is the fastest bridge between your reactive brain and your deliberate brain. Inhale 6, hold 2, exhale 7. Count it. The counting occupies the chimp while the breathing resets your physiology. The exhale is the key — longer than the inhale, activating the parasympathetic brake. Practice it daily for a week. Test it in training. Then deploy it when it counts.
...
The athletes who perform consistently — the ones who deliver in races, who execute their plans, who stay composed when things get hard — aren't the ones who never have bad thoughts or painful sensations. They're the ones who know how to move the spotlight. They notice the pain, and then they put the spotlight somewhere else. They see the gap, and then they redirect to something productive. They hear the chimp screaming, and they point the spotlight at their breathing instead.

Attentional control. It's unglamorous. Nobody's making Instagram reels about it. But it might be the single most trainable, most impactful mental skill in endurance sport.
...
Cross these two dimensions and you get four quadrants. Each one is useful in endurance sport, and each one is appropriate for different situations.

Broad-external: scanning the race field, reading the terrain ahead, assessing competitor positions, judging the wind, choosing a line through a technical section. This is tactical awareness. You need it at the start of races, in group rides, on technical courses.
...
And one mode — usually the one you're weakest at — will feel almost impossible to sustain. You'll try to focus on it and your mind will snap back to its default mode within seconds. That mode? That's the one you need to practice the most. Because that's the one the chimp is keeping you away from.

Most endurance athletes are stuck in narrow-internal on pain and effort. They live in that quadrant. Every ride, every run. The Spotlight Drill trains you to move out of it — on purpose, deliberately — and to access the other modes that are available to you. Modes that are more productive, less anxiety-inducing, and in many cases more conducive to actual performance.

The goal isn't to pick one "best" quadrant and stay there. There is no best quadrant. The goal is attentional flexibility — the ability to go wherever you need to be, whenever you need to be there, and to shift smoothly when the situation demands it. Broad-external when you need tactical awareness. Narrow-external when you need technical precision. Narrow-internal when you need to monitor pacing. And the ability to release from any of them when they stop serving you.

That flexibility? That's one of the most underrated performance skills in all of endurance sport. And it's completely trainable. You're going to train it on your next long session.

### THE CLOSE

Your attention is a spotlight you control — or one that controls you, if you haven't trained it. Nideffer gave us the four quadrants. Kabat-Zinn showed us how to move through them without judgment. The MSPE researchers proved that attention training works for endurance athletes specifically — and that the effects last. Elite athletes don't just focus harder. They focus differently — shifting between broad and narrow, internal and external, depending on what the moment demands. The Spotlight Drill builds that flexibility.
...
These tools are simple. Some of them sound almost too simple. God it sounds dumb, doesn't it? A breathing exercise? Naming the chimp? Counting to seven?

Too bad. Do it anyway.

Your mind, just like your heart and muscles, is trainable. So train it.

Are you with me? Good. See you in Module 2.
